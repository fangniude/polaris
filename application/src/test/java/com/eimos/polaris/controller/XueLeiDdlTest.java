...
class XueLeiDdlTest {
    public static final String DATA = "供应商法人,供应商法人编码,,,唯一索引,,否,\n" +
            ...
            "制造产品设计BOM,制造产品设计BOM编码,,,唯一索引,,否,\n" +
            "制造产品设计BOM,制造产品设计BOM名称,,,,,,\n" +
            "制造产品设计BOM,源系统编码,,,有序索引,,否,\n" +
            "制造产品设计BOM行,制造产品设计BOM编码,,,有序索引,制造产品设计BOM编码,否,\n" +
            "制造产品设计BOM行,物料编码,,,有序索引,物料编码,否,\n" +
            "制造产品设计BOM行,物料数量,小数,,,,,\n" +
            "制造产品设计BOM行,物料单位,,,,,,\n" +
            "客户法人,客户法人编码,,,唯一索引,,否,\n" +
            "客户法人,客户法人名称,,,,,,\n" +
