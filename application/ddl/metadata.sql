/*
 ...
 Source Server         : 172.16.5.85
 Source Server Type    : PostgreSQL
 Source Server Version : 100019
 Source Host           : 172.16.5.85:5432
 Source Catalog        : xuelei_polaris
...
;
ALTER TABLE "metadata"."entity" OWNER TO "postgres";
...
CREATE TABLE "metadata"."relation" (
  ...
  "create_time" timestamp(6) NOT NULL,
  "expired_time" timestamp(6) NOT NULL,
  "source_point" varchar(255) COLLATE "pg_catalog"."default" NOT NULL,
  "reference_point" varchar(255) COLLATE "pg_catalog"."default" NOT NULL
)
;
ALTER TABLE "metadata"."relation" OWNER TO "postgres";
